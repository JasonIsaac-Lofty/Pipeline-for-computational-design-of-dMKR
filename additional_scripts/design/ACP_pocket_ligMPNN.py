...
sys.path.append(f"/data/liyunhao/software/LigandMPNN")
import mpnn_api
from mpnn_api import MPNNRunner

# Utility scripts
sys.path.append(f"/data/liyunhao/Research/New_tSCA/scripts/utils")
...
DAB = f"/data/liyunhao/Research/2p2/RFdiffusionAA/scripts/utils/DAlphaBall.gcc" # This binary was compiled on UW systems. It may or may not work correctly on yours
